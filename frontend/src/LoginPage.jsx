...
<form className="mt-6 space-y-4"action={formAction}>
    ...
    <div>
        ...
        <input type="username" placeholder="Enter your username" name='username' className="mt-1 w-full rounded border border-gray-300 px-3 py-2
    ...
    <div>
        ...
        <input type="password" placeholder="Enter your password" name='password' className="mt-1 w-full rounded border border-gray-300 px-3 py-2
                focus:border-blue-600 focus:ring-1 focus:ring-blue-200
                outline-none" />
    </div>
    ...
    <button  disabled={ispending} className="w-full bg-blue-700 hover:bg-blue-800
                text-white font-semibold py-2.5 rounded transition" type='submit'>
